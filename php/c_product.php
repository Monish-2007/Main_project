...
<head>
    ...
    <link rel="stylesheet" href="../css/c_product.css">
...
<body>
    <div class="main-container">
        ...
        <div class="sub-container2">
            ...
            $query = mysqli_query($conn,"select * from product_details where pcategory='$pcategory'");
            ...
            ?>
                <div class="p1">
                    <a href="./php/likes.php?pid=<?php echo $row['pid'] ?>" id="plike"><i class="fa-solid fa-heart"></i></i></a>
            ...
            {
            ?>
                <h2 style="margin-left:45%;">Product not found</h2>
            <?php
            }
            }
            ?>
